...
_registerEventHandler() {
  ...
  platformFFI.registerEventHandler('token_invalid', 'token_invalid', (_) async {
    debugPrint("Received token_invalid event, logging out...");
    await gFFI.userModel.logOut(resetAuto: false);
    BotToast.showText(
