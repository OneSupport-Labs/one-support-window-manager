  ...
  Widget _buildRemoteIDTextField(BuildContext context) {
    var w = Container(
      ...
      child: Ink(
        child: Column(
          children: [
            // Title for the card, reusing the existing title widget but localized context is minimal
                    ...
                    return Obx(() => TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              fillColor: Theme.of(context)
                                  ...
                                  .withOpacity(0.5), // Subtle inner background
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8),
                                borderSide:
                                    BorderSide(color: MyTheme.accent, width: 2),
                              ),
                              counterText: '',
            ...
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                SizedBox(
                  height: 38.0, // Taller button
                  child: ElevatedButton(
                    onPressed: () {
                      onConnect();
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor: MyTheme.accent, // Primary Color
                ...
                Container(
                  height: 38.0, // Match button height
                  width: 38.0,
                  decoration: BoxDecoration(
                    border: Border.all(
