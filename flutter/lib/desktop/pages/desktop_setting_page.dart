  ...
  List<_TabInfo> _settingTabs() {
    ...
    for (final tab in DesktopSettingPage.tabKeys) {
      if (!gFFI.userModel.isLogin &&
          tab != SettingsTabKey.account &&
          tab != SettingsTabKey.about) {
        continue;
      }
      switch (tab) {
        ...
        children: <Widget>[
          SizedBox(
            ...
            child: Column(
              children: [
                _header(context),
                Flexible(child: Obx(() => _listView(tabs: _settingTabs()))),
              ],
            ),
          ),
  ...
  Widget viewStyle(BuildContext context) {
    ...
    return _Card(title: 'Default View Style', children: [
      _Radio<String>(context,
          ...
          onChanged: isOptFixed ? null : (v) => onChanged(v)),
      _Radio<String>(context,
...
class _AccountState extends State<_Account> {
  ...
  Widget accountAction() {
    return Obx(() => _Button(
        gFFI.userModel.isLogin ? 'Logout' : 'Login',
        () =>
            {gFFI.userModel.isLogin ? logOutConfirmDialog() : loginDialog()}));
  }
  ...
  Widget useInfo() {
    ...
    return Obx(() => Offstage(
          offstage: gFFI.userModel.userNameC.value.isEmpty,
          child: Column(
            children: [
              text('Username', gFFI.userModel.userNameC.value),
        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://1support.co.kr/privacy');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://1support.co.kr/terms');
                  },
                  child: Text(
                    translate('이용약관'),
                    style: linkStyle,
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://1support.co.kr/');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              SelectionArea(
                  child: Text(
                'Copyright © ${DateTime.now().toString().substring(0, 4)} PIN2\n$license',
              )).marginSymmetric(vertical: 4.0)
            ],
          ).marginOnly(left: _kContentHMargin)
        ]),
        ...
        Flexible(
          child: SizedBox(
            ...
            child: Container(
              ...
              ).marginOnly(bottom: 15), // Increased bottom margin slightly
