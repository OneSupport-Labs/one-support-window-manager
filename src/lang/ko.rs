...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Request access to your device", "원격 제어 접근 승인을 대기 중입니다"),
        ...
        ("printer-requires-installed-{}-client-tip", "원격 인쇄 기능을 사용하려면 이 장치에 원서포트 매니저를 설치해야 합니다."),
        ("printer-{}-not-installed-tip", "원서포트 매니저 프린터가 설치되지 않았습니다."),
        ("printer-{}-ready-tip", "원서포트 매니저 프린터가 설치되어 사용할 준비가 되었습니다."),
        ("Install {} Printer", "원서포트 매니저 프린터 설치"),
